...
import com.example.fileuploaddemo.dao.ImageRepository;
...
public class ImageUploadController {
	...
	public @ResponseBody BodyBuilder uploadImage(@RequestParam("imageFile") MultipartFile file) throws IOException{
